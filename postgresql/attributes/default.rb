...
default['postgresql']['server']['init_package'] =
  ...
  when 'opensuse'
    if node['platform_version'].to_f < 13
      'sysv'
    else
      'systemd'
    end
...
when 'debian'
  ...
  if node['platform_version'].to_f < 6.0 # All 5.X
  ...
  elsif node['platform_version'].to_f < 7.0 # All 6.X
  ...
  elsif node['platform_version'].to_f < 8.0 # All 7.X
