...
if mem >= 256
  ...
  work_mem =
    { 'web' => mem_con_v,
      ...
      'dw' => mem_con_v / 2,
      'mixed' => mem_con_v / 2,
      'desktop' => mem_con_v / 6 }.fetch(db_type)
